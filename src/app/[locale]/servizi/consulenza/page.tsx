          ...
          <ScrollFadeIn animation="fade-up">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">
                <span className="text-foreground">Come Possiamo</span>
                <span className="block text-fuchsia-400">Aiutarti</span>
              </h2>
            </div>
          </ScrollFadeIn>
          ...
          <ScrollFadeIn animation="fade-up">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                <span className="text-foreground">Come</span>
                <span className="block text-fuchsia-400">Lavoriamo</span>
              </h2>
            </div>
          </ScrollFadeIn>
            ...
            <ScrollFadeIn animation="fade-up">
              <Card className="holographic-card neon-border overflow-hidden">
                <CardContent className="p-8 md:p-12">
                  <h3 className="text-2xl sm:text-3xl font-bold mb-8 text-center text-fuchsia-400">Aree di Consulenza</h3>
          ...
          <ScrollFadeIn animation="scale">
            <Card className="max-w-4xl mx-auto animated-gradient-border overflow-hidden">
              <div className="bg-card p-8 md:p-12 text-center">
                ...
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">
                  <span className="text-foreground">Hai un Progetto</span>
                  <span className="block text-fuchsia-400">in Mente?</span>
                </h2>
                
                <p className="text-muted-foreground max-w-2xl mx-auto mb-8">
                  Prenota una call gratuita di 30 minuti per discutere delle tue esigenze e scoprire come possiamo aiutarti.
                </p>
